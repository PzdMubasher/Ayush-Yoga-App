        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            child: ListTile(
              ...
              title: Text(pose.name, style: GoogleFonts.outfit(fontWeight: FontWeight.bold, fontSize: 18)),
              subtitle: Text(pose.description, style: GoogleFonts.outfit(fontSize: 13, color: Colors.black54)),
              trailing: const Icon(Icons.arrow_forward_ios, size: 16, color: Color(0xFF004D40)),
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => PoseDetailScreen(pose: pose))),
            ),
          );
        },
      ),
